...
public class GovernorFragment extends Fragment {
    ...
    private static final String TAG = "GovernorActivity";
    ...
    private void getImages() {
        ...
        mImage.add(R.drawable.greenarrow);
